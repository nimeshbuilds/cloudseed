...
!!! info "Generated from the code"
    This page is generated by `scripts/gen-docs.py` from the CLI's help pages (`cloudseed/help.py`), so it always matches the CLI you install (this build: cloudseed 0.2.0).
...
```text
cloudseed 0.2.0 - secure multi-cloud landing zones (AWS, GCP, Azure, local VMware) with Terraform.

...
!!! info "Generated from the code"
    This page is generated by `scripts/gen-docs.py` from `terraform/azure/variables.tf`, `terraform/azure/outputs.tf`, the setup questions and `skills/cloudseed-azure/SKILL.md`, so it always matches the CLI you install (this build: cloudseed 0.2.0).

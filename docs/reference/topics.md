...
!!! info "Generated from the code"
    This page is generated by `scripts/gen-docs.py` from the CLI's help topics (`cloudseed/help.py`), so it always matches the CLI you install (this build: cloudseed 0.2.0).

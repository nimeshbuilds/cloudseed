...
!!! info "Generated from the code"
    This page is generated by `scripts/gen-docs.py` from `terraform/vmware/variables.tf`, `terraform/vmware/outputs.tf`, the setup questions and `skills/cloudseed-vmware/SKILL.md`, so it always matches the CLI you install (this build: cloudseed 0.1.0).
